...
module FsUnity.Control.Collections.ReaderState
...
/// The FsUnity.Collections.TaggedArray module, lifted into the ReaderState monad.
[<RequireQualifiedAccess; CompilationRepresentation(CompilationRepresentationFlags.ModuleSuffix)>]
module TaggedArray =
...
/// The FsUnity.Collections.ArrayView module, lifted into the ReaderState monad.
[<RequireQualifiedAccess; CompilationRepresentation(CompilationRepresentationFlags.ModuleSuffix)>]
module ArrayView =
