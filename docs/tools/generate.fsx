...
let website = "/FsUnity.Core"

let githubLink = "http://github.com/FsUnity/FsUnity.Core"

// Specify more information about your project
let info =
  [ "project-name", "FsUnity.Core"
    "project-author", "Jared Hester"
    "project-summary", "Backport of FSharp.Core for compatibility with Unity3d Game Engine"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/FsUnity.Core" ]
